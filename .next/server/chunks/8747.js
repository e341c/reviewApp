...
/* harmony import */ var react_bootstrap_InputGroup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9136);
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_4__.library.add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__/* .faSearch */ .wn1, _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__/* .faXmark */ .g82);
function SearchBar({ url }) {
    ...
    const { data, error, isLoading } = (0,swr__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .ZP)(url, async ()=>{
        const res = await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.get(`${url}?search=${search}`);
        return res.data;
    }, {
        refreshInterval: 100
    });
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_InputGroup__WEBPACK_IMPORTED_MODULE_7___default()), {
        className: "me-3",
        children: [
