...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 91018)), "/Users/eriktabys/Desktop/Itransitions/recommendations/client/app/review/edit/[id]/page.jsx"],
...
const pages = ["/Users/eriktabys/Desktop/Itransitions/recommendations/client/app/review/edit/[id]/page.jsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/review/edit/[id]/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/review/edit/[id]/page",
        pathname: "/review/edit/[id]",
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3213))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EditReview)
/* harmony export */ });
...
function EditReview({ params }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setUpload(true);
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.post(API_URL + `/api/review/edit/${id}`, bodyFormData, {
                headers: {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        const getAllData = async ()=>{
            setUpload(true);
            try {
                const categoriesData = await axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.get(API_URL + "/api/category").then((responce)=>responce.data);
                setCategories(categoriesData);
                const tagsData = await axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.get(API_URL + "/api/tags").then((responce)=>responce.data);
                setTagsOptions(tagsData);
                const res = await axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.get(API_URL + `/api/review/${id}`).then((responce)=>responce.data);
                setData(res);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("main", {
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_11___default()), {
                onSubmit: handleSubmit,
                children: [
                    upload && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Loading__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z, {}),
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/eriktabys/Desktop/Itransitions/recommendations/client/app/review/edit/[id]/page.jsx`)
