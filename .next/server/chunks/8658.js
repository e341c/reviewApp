...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6409))
...
/* harmony import */ var _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(69024);
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_4__.library.add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__/* .faBars */ .xiG);
function Categories({ getCategoryName }) {
    const { data, error, isLoading } = (0,swr__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)("/api/category", async ()=>{
        const res = await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.get(`/api/category`);
        return res.data;
    }, {
        refreshInterval: 100
    });
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        children: [
            ...
            data?.map((item)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_7___default().Item), {
...
var core_dist = __webpack_require__(97146);
...
var Categories = __webpack_require__(92318);
// EXTERNAL MODULE: ./node_modules/react-bootstrap/cjs/DropdownButton.js
var DropdownButton = __webpack_require__(4920);
var DropdownButton_default = /*#__PURE__*/__webpack_require__.n(DropdownButton);
...
fontawesome_svg_core.library.add(free_solid_svg_icons/* faSearch */.wn1, free_solid_svg_icons/* faXmark */.g82);
function SearchBar({ url }) {
    const router = (0,navigation.useRouter)();
    const [search, setSearch] = (0,react_.useState)("");
    const { data, error, isLoading } = (0,core_dist/* default */.ZP)(url, async ()=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)((InputGroup_default()), {
        className: "me-3",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx((DropdownButton_default()), {
                variant: "outline-primary",
                title: "",
                id: "input-group-dropdown-1",
                children: /*#__PURE__*/ jsx_runtime_.jsx(Categories/* default */.Z, {
                    getCategoryName: (name)=>setSearch(name)
                })
            }),
...
function Header() {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("nav", {
        className: "navbar fixed-top navbar-expand-lg bg-body shadow z-3",
