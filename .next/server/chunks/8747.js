...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 63690))
...
function Categories({ getCategoryName }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            data?.map((item)=>/*#__PURE__*/ jsx_runtime_.jsx((Dropdown_default()).Item, {
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx(SearchBar, {
                                    url: path === "/" && "/api/review" || path === "/profile" && `/api/profile/${id}` || `/api${path}`
                                }),
